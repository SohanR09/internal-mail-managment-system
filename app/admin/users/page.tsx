...
export default async function AdminUsersPage() {
  ...
  return <main className="min-h-screen bg-background text-foreground"><PageHeader title="Admin users" backHref={`/mail/${defaultFolder}`} /><AdminUsers initialUsers={safeUsers} roles={roles} /></main>;
}
