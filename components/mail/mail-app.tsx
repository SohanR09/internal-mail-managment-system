...
const MailRow = memo(function MailRow({
  ...
  return (
    <article
      className={`mail-row flex items-center gap-4 border-b border-border px-6 cursor-pointer hover:bg-accent ${rowHeight} ${item.state.isRead ? "bg-accent/40" : "bg-accent/20"}`}
    >
      <input
